...
App Transport Security: for production use HTTPS; for local LAN testing you may need an ATS exception.
...
Railway / Fly.io / Cloudflare Containers work the same: install deps, run uvicorn, expose port.

### Env vars

None required. Optional:

- `ORT_LOGGING_LEVEL=3` — quieter ONNX logs
- `PORT` — provided by hosts like Render
